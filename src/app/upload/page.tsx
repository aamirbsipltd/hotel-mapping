...
// The matcher product page — the residual self-serve layer the
// done-for-you marketing site sits alongside. The original landing
// content lives here above the form; CTAs that used to send visitors
// to /upload now anchor-scroll to the form on this page.

export const metadata = {
  title: 'Map your hotel inventory to Tripadvisor — Hotel Mapping Tool',
  description:
    'Upload a CSV of your hotels. Get back Tripadvisor Location IDs with transparent confidence scoring and a one-click review queue for low-confidence matches.',
};
...
const OUTPUT_PREVIEW = [
  { name: 'Grand Hyatt Berlin', locationId: '262256', score: '96%' },
  { name: 'Hotel Adlon Kempinski', locationId: '508038', score: '98%' },
  { name: 'Mandarin Oriental Paris', locationId: '1501508', score: '91%' },
  { name: 'The Ritz London', locationId: '200838', score: '94%' },
];
    ...
    <div className="flex flex-col">
      ...
      <section className="mx-auto max-w-5xl px-4 pt-20 pb-16 text-center space-y-6">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <a href="#upload-form" className={cn(buttonVariants({ size: 'lg' }), 'gap-2')}>
      ...
      <section id="upload-form" className="mx-auto max-w-2xl px-4 py-16 scroll-mt-20">
